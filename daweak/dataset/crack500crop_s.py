...
class CRACK500CROPSSegmentation(data.Dataset):
    def __init__(
            self,
            dataset=None,
            path=None,
        ...
        # load dataset
        # CRACK500_20160222_080850_641_361_leftImg8bit_quarter_1.png
        ...
        for name in self.img_ids:
            ...
            label_file = osp.join(self.path, "gtFine/%s/%s_gtFine_labelIds_%s" % (self.split, name[:-26], name[-13:]))
            self.files.append({
                "img": img_file,
                "label": label_file,
                "name": name
