...
class GAPs384SegmentationSource(data.Dataset):
    def __init__(
            self,
            dataset=None,
            path=None,
        ...
        self.mean = np.array((101.86745326, 101.86745326, 101.86745326), dtype=np.float32)
        ...
        for name in self.img_ids:
            ...
            if use_pixeladapt:
                p_img_file = osp.join(
                    '/home/user/WindowsShare/05. Data/00. Benchmarks/30. GAPs384_crop',
