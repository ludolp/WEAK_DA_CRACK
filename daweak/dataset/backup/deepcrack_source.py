...
class DeepCrackSegmentationSource(data.Dataset):
    def __init__(
            self,
            dataset=None,
            path=None,
        ...
        self.mean = np.array((152.584635, 149.12654106, 144.02280361), dtype=np.float32)
        ...
        for name in self.img_ids:
            ...
            if use_pixeladapt:
                p_img_file = osp.join(
                    '/home/user/WindowsShare/05. Data/00. Benchmarks/28. DeepCrack_Khanhha',
