...
SCRIPT_DIR="/home/user/WEAK_DA/weak-da-seg/scripts"
source $SCRIPT_DIR/common_gta5_to_cityscapes.sh


# weak-point-cw-pa -> ~ 56.42
#
snapshot_dir="snapshot/"$source"-"$target"-weakpoint-cw-pa-1120"
result_dir="result/"$source"-"$target"-weakpoint-cw-pa-1120"
python train.py \
    --model $model \
